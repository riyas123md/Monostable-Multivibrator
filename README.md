...
## Tabulation
<img width="925" height="265" alt="image" src="https://github.com/user-attachments/assets/97720b5b-2114-4663-b9fd-e08485da716a" />## Waveform
...
A monostable multivibrator is a circuit having one stable state and one quasi-stable state. It produces a single output pulse when triggered.
...
The stable state is LOW output.

4.	Why is it called “one-shot”?

Because it produces only one output pulse for each trigger input.
